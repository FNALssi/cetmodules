...
macro( parse_underscored_version _VERSION )
  ...
  ##message(STATUS "parse_ups_version: ${_VERSION} has ${nunder} underscores" )
...
macro( set_version_from_ups _VERSION )

  parse_ups_version( ${_VERSION} )
