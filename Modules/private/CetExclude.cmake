...
# (or CMAKE_CURRENT_SOURCE_DIR if not). BASENAME_EXCLUDES are applied
# only to the basenames of files and should *not* contain `/' directory
# separators. If any special globbing characters (`[', `]`, `*', `?', or
# `+') are present in a BASENAME_EXCLUDE member, it will be treated as a
# globbing pattern in the directory of every member of LIST.
function (_cet_exclude_from_list OUTPUT_VAR)
  cmake_parse_arguments(PARSE_ARGV 1 XL "" "BASE_DIR" "BASENAME_EXCLUDES;EXCLUDES;LIST")
  set(GLOBS)
  set(BASENAME_EXCLUDES)
  foreach (myfile IN LISTS XL_BASENAME_EXCLUDES)
    if (${myfile} MATCHES "/")
      message(FATAL_ERROR "specified BASENAME_EXCLUDES ${myfile} is not a basename")
  ...
  foreach (myfile IN LISTS XL_LIST)
    ...
    if (GLOBS)
      ...
      file(GLOB matches LIST_DIRECTORIES FALSE ${local_globs})
