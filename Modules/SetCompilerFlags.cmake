...
function(cet_report_compiler_flags)
  ...
  message(${CRCF_REPORT_THRESHOLD} "Global CMAKE_<lang>_FLAGS* variables in the current scope"
  ...
  foreach(prop IN ITEMS COMPILE_DEFINITIONS COMPILE_OPTIONS
    ...
    if (items)
      ...
      message(${CRCF_REPORT_THRESHOLD} "  * property ${prop} for the current scope:")
      foreach(item IN LISTS items)
        message(${CRCF_REPORT_THRESHOLD} "      ${item}")
      endforeach()
    endif()
  endforeach()
  message(${CRCF_REPORT_THRESHOLD} "  * properties modified at lower-level directories")
  message(${CRCF_REPORT_THRESHOLD} "  * target- and source-specific directories.")
  if (gen_exps)
    list(JOIN gen_exps ", " gen_exps_string)
    message(${CRCF_REPORT_THRESHOLD} "some variables or properties (${gen_exps_string})"
      " contain generator expressions (\$<...>) and will be resolved later.")
      message(${CRCF_REPORT_THRESHOLD} "build with generator verbosity to see actual definitions and"
