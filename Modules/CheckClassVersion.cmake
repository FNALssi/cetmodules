...
function(check_class_version)
  ...
  if (TARGET ${dictname}_dict)
    ...
    string(JOIN ":" LD_PATH_FOR_DICT "${LD_PATH_FOR_DICT}" $ENV{LD_LIBRARY_PATH})
    if (APPLE)
      list(APPEND CMD_ENV "DYLD_LIBRARY_PATH=${LD_PATH_FOR_DICT}")
    else()
      list(APPEND CMD_ENV "LD_LIBRARY_PATH=${LD_PATH_FOR_DICT}")
    endif()
