...
if (libwda_FOUND)
  ...
  find_file(_cet_wda_h NAMES wda.h HINTS ENV LIBWDA_INC)
  if (_cet_wda_h)
  ...
  if (EXISTS "${_cet_libwda_include_dir}")
    ...
    find_library( libwda_LIBRARY NAMES wda PATHS ${libwda_LIBRARY_DIR} REQUIRED)
  endif()
endif()
if (libwda_FOUND)
  if (NOT TARGET wda::wda)
    add_library(wda::wda SHARED IMPORTED)
    set_target_properties(wda::wda PROPERTIES
      INTERFACE_INCLUDE_DIRECTORIES "${libwda_INCLUDE_DIRS}"
...
find_package_handle_standard_args(libwda ${_cet_libwda_config_mode}
  REQUIRED_VARS libwda_FOUND
  libwda_INCLUDE_DIRS
  libwda_LIBRARY)
