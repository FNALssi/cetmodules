...
if (Jsonnet_EXECUTABLE)
  find_library(Jsonnet_LIBRARY NAMES jsonnet
    DOC "Jsonnet library")
  mark_as_advanced(Jsonnet_LIBRARY)
  find_library(Jsonnet_CXX_LIBRARY NAMES jsonnet++
  ...
  # jsonnet executable location.
  set(__doJsonnetVersionCheck TRUE)
  get_property(__jsonnetVersionProp GLOBAL
  ...
  if (__jsonnetVersionProp)
    ...
    if (__jsonnetExe STREQUAL Jsonnet_EXECUTABLE AND NOT __jsonnetVersion STREQUAL "")
  ...
  if (__doJsonnetVersionCheck)
    execute_process(COMMAND ${Jsonnet_EXECUTABLE} --version
  ...
  if (_findjsonnet_role STREQUAL "PROJECT")
    if (NOT TARGET Jsonnet::jsonnet)
      ...
      set_property(TARGET Jsonnet::jsonnet PROPERTY IMPORTED_LOCATION "${Jsonnet_EXECUTABLE}")
    endif()
    if (NOT TARGET Jsonnet::jsonnetfmt)
      add_executable(Jsonnet::jsonnetfmt IMPORTED)
      set_property(TARGET Jsonnet::jsonnetfmt PROPERTY IMPORTED_LOCATION "${Jsonnet_EXECUTABLE}fmt")
    endif()
...
find_package_handle_standard_args(Jsonnet
