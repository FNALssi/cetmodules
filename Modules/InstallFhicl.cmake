...
function(install_fhicl)
  ...
  if (IFCL_LIST)
    ...
    install(PROGRAMS ${IFCL_LIST} DESTINATION ${fhicl_install_dir})
  else()
    if (IFCL_EXTRAS)
      install(PROGRAMS ${IFCL_EXTRAS} DESTINATION ${fhicl_install_dir})
    endif()
    file(GLOB fhicl [^.]*.fcl)
    if (fhicl)
      install(PROGRAMS ${fhicl} DESTINATION ${fhicl_install_dir})
      if (IFCL_SUBDIRS)
        foreach(sub ${IFCL_SUBDIRS})
          ...
          if (subdir_fhicl)
            install(PROGRAMS ${subdir_fhicl} DESTINATION ${fhicl_install_dir})
          endif()
        endforeach()
      endif()
  endif()
